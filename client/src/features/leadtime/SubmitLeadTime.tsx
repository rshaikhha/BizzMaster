...
export default function SubmitLeadTime() {
    ...
    const onSubmit = (data: FormValues) => {
        ...
        agent.Suppliers.postLeadTime(data).then(() => history.push(`/leadtime/${id}`))
            .catch((e) => {
                setError("items", {
                    type: "manual",
        ...
        <Paper sx={{ p: 4 }}>
            ...
            <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate sx={{ mt: 1 }}>
                ...
                <Grid container spacing={2} sx={{ ml: 4, mb: 4, alignContent: "center" }}>
                    ...
                    <Grid item xs={2}>
                        <Button variant="contained" color="error" fullWidth component={NavLink} to={`/LeadTime/${id}`}>
                            CANCEL
                        </Button>
                    </Grid>
                </Grid>
